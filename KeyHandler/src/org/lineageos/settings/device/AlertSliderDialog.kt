...
class AlertSliderDialog(context: Context) : Dialog(context, R.style.alert_slider_theme) {
    ...
    fun setState(position: Int, ringerMode: Int) {
        ...
        iconView.setImageResource(when (ringerMode) {
            ...
            KeyHandler.KEY_VALUE_PRIORTY_ONLY -> R.drawable.ic_notifications_alert
            KeyHandler.KEY_VALUE_TOTAL_SILENCE -> R.drawable.ic_notifications_silence
            else -> R.drawable.ic_info
        })

        textView.setText(when (ringerMode) {
            KeyHandler.KEY_VALUE_SILENT -> R.string.notification_slider_mode_silent
            KeyHandler.KEY_VALUE_VIBRATE -> R.string.notification_slider_mode_vibrate
            KeyHandler.KEY_VALUE_NORMAL -> R.string.notification_slider_mode_none
            KeyHandler.KEY_VALUE_PRIORTY_ONLY -> R.string.notification_slider_mode_priority_only
            KeyHandler.KEY_VALUE_TOTAL_SILENCE -> R.string.notification_slider_mode_total_silence
